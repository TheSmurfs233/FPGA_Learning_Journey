...
HD_PWD='D:/FPGA_Learning_Journey/Pro/XMDA/project/project.runs/design_1_axi_bram_ctrl_0_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_bram_ctrl_0_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_bram_ctrl_0_bram_1.tcl
