...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SPI/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oled_display.tcl
