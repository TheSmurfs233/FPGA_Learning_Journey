...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SPI/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oled_display.tcl -notrace
