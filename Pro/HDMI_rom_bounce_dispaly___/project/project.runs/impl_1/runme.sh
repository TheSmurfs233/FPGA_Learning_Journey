...
HD_PWD='D:/FPGA_Learning_Journey/Pro/HDMI_rom_bounce_dispaly___/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_char.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_char.tcl -notrace
