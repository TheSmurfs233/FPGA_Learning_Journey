...
HD_PWD='D:/FPGA_Learning_Journey/Pro/ETH_udp_send_rgmii___/project without ipchecksum/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_send_test_rgmii.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_send_test_rgmii.tcl -notrace
