...
HD_PWD='D:/FPGA_Learning_Journey/Pro/ETH_udp_send_rgmii___/project without ipchecksum/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_send_test_rgmii.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_send_test_rgmii.tcl
