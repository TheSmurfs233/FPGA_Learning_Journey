...
#
# Generated by export_simulation on Thu Mar 06 21:42:45 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './eth_dcfifo.sh' script.

./eth_dcfifo.sh -reset_run
...
./eth_dcfifo.sh -noclean_files

For more information on the script, please type './eth_dcfifo.sh -help'.
