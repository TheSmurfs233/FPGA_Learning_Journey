...
HD_PWD='D:/FPGA_Learning_Journey/Pro/VGA_drive/project/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_drive.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_drive.tcl -notrace
