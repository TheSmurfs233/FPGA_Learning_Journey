...
#
# Generated by export_simulation on Mon Mar 03 17:57:12 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rx_pll.sh' script.
...
./rx_pll.sh -noclean_files

For more information on the script, please type './rx_pll.sh -help'.
