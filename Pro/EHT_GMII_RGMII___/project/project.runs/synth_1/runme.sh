...
HD_PWD='D:/FPGA_Learning_Journey/Pro/EHT_GMII_RGMII___/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgmii_to_gmii.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgmii_to_gmii.tcl
