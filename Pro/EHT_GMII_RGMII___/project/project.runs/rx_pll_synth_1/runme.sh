...
HD_PWD='D:/FPGA_Learning_Journey/Pro/EHT_GMII_RGMII___/project/project.runs/rx_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_pll.tcl
