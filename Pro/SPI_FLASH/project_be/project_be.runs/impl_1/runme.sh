...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SPI_FLASH/project_be/project_be.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_flash_be.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_flash_be.tcl -notrace
