...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SPI_FLASH/project_read/project_read.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_flash_read.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_flash_read.tcl -notrace
