...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SPI_FLASH/project_pp/project_pp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_flash_pp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_flash_pp.tcl
