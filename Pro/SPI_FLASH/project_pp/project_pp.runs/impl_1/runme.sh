...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SPI_FLASH/project_pp/project_pp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_flash_pp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_flash_pp.tcl -notrace
