...
HD_PWD='D:/FPGA_Learning_Journey/Pro/PLL/project/PLL_IPCoreFreqTransform.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_top.tcl
