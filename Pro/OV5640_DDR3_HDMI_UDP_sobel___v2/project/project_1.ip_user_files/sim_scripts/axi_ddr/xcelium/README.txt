...
#
# Generated by export_simulation on Tue Jun 17 17:50:33 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './axi_ddr.sh' script.

./axi_ddr.sh -reset_run
...
./axi_ddr.sh -noclean_files

For more information on the script, please type './axi_ddr.sh -help'.
