...
/* synthesis syn_black_box black_box_pad_pin="wr_clk,wr_rst,rd_clk,rd_rst,din[15:0],wr_en,rd_en,dout[63:0],full,almost_full,empty,almost_empty,rd_data_count[8:0],wr_data_count[10:0]" */;
  input wr_clk;
  input wr_rst;
  input rd_clk;
  input rd_rst;
