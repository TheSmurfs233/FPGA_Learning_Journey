...
HD_PWD='D:/CNN/OV5640_DDR3_HDMI_UDP_gray_v3___/project/project_1.runs/buf_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buf_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buf_fifo.tcl
