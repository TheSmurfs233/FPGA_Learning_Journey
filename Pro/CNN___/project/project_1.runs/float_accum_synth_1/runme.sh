...
HD_PWD='D:/CNN/OV5640_DDR3_HDMI_UDP_gray___/project/project_1.runs/float_accum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_accum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_accum.tcl
