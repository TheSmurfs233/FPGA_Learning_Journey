...
HD_PWD='D:/CNN/OV5640_DDR3_HDMI_UDP_gray___/project/project_1.runs/img_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log img_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source img_rom.tcl
