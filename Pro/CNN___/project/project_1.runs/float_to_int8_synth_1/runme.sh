...
HD_PWD='C:/FPGA_Learning_Journey/Pro/CNN___/project/project_1.runs/float_to_int8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_to_int8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_to_int8.tcl
