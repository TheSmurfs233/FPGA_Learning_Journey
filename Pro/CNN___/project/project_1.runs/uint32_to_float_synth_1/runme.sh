...
HD_PWD='C:/FPGA_Learning_Journey/Pro/CNN___/project/project_1.runs/uint32_to_float_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uint32_to_float.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uint32_to_float.tcl
