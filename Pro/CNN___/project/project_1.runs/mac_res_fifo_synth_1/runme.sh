...
HD_PWD='C:/FPGA_Learning_Journey/Pro/CNN___/project/project_1.runs/mac_res_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_res_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_res_fifo.tcl
