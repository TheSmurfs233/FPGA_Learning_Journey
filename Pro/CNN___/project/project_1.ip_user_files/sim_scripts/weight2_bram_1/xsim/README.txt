...
#
# Generated by export_simulation on Wed Jul 02 15:14:37 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './weight2_bram_1.sh' script.

./weight2_bram_1.sh -reset_run
...
./weight2_bram_1.sh -noclean_files

For more information on the script, please type './weight2_bram_1.sh -help'.
