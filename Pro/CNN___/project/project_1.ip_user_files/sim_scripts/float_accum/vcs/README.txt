...
#
# Generated by export_simulation on Sun May 04 23:58:44 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './float_accum.sh' script.

./float_accum.sh -reset_run
...
./float_accum.sh -noclean_files

For more information on the script, please type './float_accum.sh -help'.
