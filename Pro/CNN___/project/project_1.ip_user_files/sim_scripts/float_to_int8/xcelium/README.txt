...
#
# Generated by export_simulation on Sun May 04 23:58:27 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './float_to_int8.sh' script.

./float_to_int8.sh -reset_run
...
./float_to_int8.sh -noclean_files

For more information on the script, please type './float_to_int8.sh -help'.
