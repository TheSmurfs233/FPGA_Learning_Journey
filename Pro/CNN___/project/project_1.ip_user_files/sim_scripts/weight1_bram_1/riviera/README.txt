...
#
# Generated by export_simulation on Wed Jul 02 15:12:13 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './weight1_bram_1.sh' script.

./weight1_bram_1.sh -reset_run
...
./weight1_bram_1.sh -noclean_files

For more information on the script, please type './weight1_bram_1.sh -help'.
