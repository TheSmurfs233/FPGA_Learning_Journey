...
#
# Generated by Vivado on Sun May 04 23:58:01 +0800 2025
# SW Build 2708876 on Wed Nov  6 21:40:23 MST 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: mac_res_fifo.sh [-help]
# usage: mac_res_fifo.sh [-lib_map_path]
# usage: mac_res_fifo.sh [-noclean_files]
# usage: mac_res_fifo.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "mac_res_fifo.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mac_res_fifo xil_defaultlib.mac_res_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mac_res_fifo -key {Behavioral:sim_1:Functional:mac_res_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./mac_res_fifo.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mac_res_fifo.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./mac_res_fifo.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: mac_res_fifo.sh [-help]\n\
Usage: mac_res_fifo.sh [-lib_map_path]\n\
Usage: mac_res_fifo.sh [-reset_run]\n\
Usage: mac_res_fifo.sh [-noclean_files]\n\n\
