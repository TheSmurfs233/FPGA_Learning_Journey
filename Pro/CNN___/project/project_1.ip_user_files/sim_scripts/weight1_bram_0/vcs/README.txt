...
#
# Generated by export_simulation on Mon May 05 00:02:07 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './weight1_bram_0.sh' script.

./weight1_bram_0.sh -reset_run
...
./weight1_bram_0.sh -noclean_files

For more information on the script, please type './weight1_bram_0.sh -help'.
