...
#
# Generated by export_simulation on Mon May 05 00:05:15 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './weight2_bram_0.sh' script.

./weight2_bram_0.sh -reset_run
...
./weight2_bram_0.sh -noclean_files

For more information on the script, please type './weight2_bram_0.sh -help'.
