...
#
# Generated by Vivado on Tue May 06 00:29:01 +0800 2025
...
# Script info
echo -e "mult.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_16 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult xil_defaultlib.mult xil_defaultlib.glbl -log elaborate.log
}
