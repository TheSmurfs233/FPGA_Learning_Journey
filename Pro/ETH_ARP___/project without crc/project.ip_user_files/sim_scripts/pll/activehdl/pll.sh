...
#
# Generated by Vivado on Mon Mar 03 22:21:18 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/FPGA_Learning_Journey/Pro/ETH_ARP___/project1/project.cache/compile_simlib/activehdl"
  fi
