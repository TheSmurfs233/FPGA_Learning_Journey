...
HD_PWD='D:/FPGA_Learning_Journey/Pro/ETH_udp_tx_rx___/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_udp_send_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_udp_send_test.tcl -notrace
