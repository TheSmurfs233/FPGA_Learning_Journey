...
HD_PWD='D:/FPGA_Learning_Journey/Pro/ETH_udp_tx_rx___/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_udp_send_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_udp_send_test.tcl
