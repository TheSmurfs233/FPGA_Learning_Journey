...
HD_PWD='D:/FPGA_Learning_Journey/Pro/OV5640_DDR3_HDMI_UDP_sobel___v3/project/project_1.runs/axi_ddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ddr.tcl
