...
HD_PWD='D:/FPGA_Learning_Journey/Pro/OV5640_DDR3_HDMI_UDP_sobel___v3/project/project_1.runs/eth_dcfifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_dcfifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_dcfifo.tcl
