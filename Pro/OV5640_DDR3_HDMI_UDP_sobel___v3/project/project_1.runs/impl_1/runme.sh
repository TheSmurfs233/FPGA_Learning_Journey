...
HD_PWD='D:/FPGA_Learning_Journey/Pro/OV5640_DDR3_HDMI_UDP_sobel___v3/project/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ddr3_test.tcl -notrace
