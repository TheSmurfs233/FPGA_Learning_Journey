...
HD_PWD='D:/FPGA_Learning_Journey/Pro/OV5640_DDR3_HDMI_UDP_sobel___v3/project/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr3_test.tcl
