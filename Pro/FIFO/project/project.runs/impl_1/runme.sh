...
HD_PWD='D:/FPGA_Learning_Journey/Pro/FIFO/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_sum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_sum.tcl -notrace
