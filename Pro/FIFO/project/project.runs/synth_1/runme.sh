...
HD_PWD='D:/FPGA_Learning_Journey/Pro/FIFO/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_sum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_sum.tcl
