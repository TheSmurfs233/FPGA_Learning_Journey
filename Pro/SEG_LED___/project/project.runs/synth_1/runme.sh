...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SEG_LED___/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_key_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_key_top.tcl
