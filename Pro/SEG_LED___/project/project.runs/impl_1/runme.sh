...
HD_PWD='D:/FPGA_Learning_Journey/Pro/SEG_LED___/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_key_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_key_top.tcl -notrace
