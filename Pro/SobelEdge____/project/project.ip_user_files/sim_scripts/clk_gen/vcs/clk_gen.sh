...
#
# Generated by Vivado on Thu Feb 13 18:40:52 +0800 2025
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../project.srcs/sources_1/ip/clk_gen/clk_gen_clk_wiz.v" \
    "$ref_dir/../../../../project.srcs/sources_1/ip/clk_gen/clk_gen.v" \
  2>&1 | tee -a vlogan.log
